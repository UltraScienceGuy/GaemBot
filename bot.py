...
async def help(ctx):
    ...
    embed.add_field(name="g!searchurban <word + word2>, there can also only be one word", value="Searches urban dictionary for a word that you tell the bot", inline=False)
